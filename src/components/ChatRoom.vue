  ...
  <b-row>
    <b-col cols="12">
      ...
      <b-list-group class="panel-body" v-chat-scroll>
        <b-list-group-item v-for="item in chats" :key="item.id" class="chat">
          <div class="left clearfix" v-if="item.nickname === nickname">
            <b-img left src="http://placehold.it/50/55C1E7/fff&text=ME" rounded="circle" width="75" height="75"
                   alt="img" class="m-1"/>
          ...
          <div class="right clearfix" v-else>
            <b-img right src="http://placehold.it/50/55C1E7/fff&text=U" rounded="circle" width="75" height="75"
                   alt="img" class="m-1"/>
            <div class="chat-body clearfix">
              <div class="header">
                <strong class="primary-font">{{ item.nickname }}</strong>
      ...
      <ul v-if="errors && errors.length">
        <li v-for="error of errors" :key="error.code">
          {{error.message}}
        </li>
      </ul>
...
export default {
    ...
    created () {
        ...
        axios.get(`https://omer-chat-api.herokuapp.com/api/chat/` + this.$route.params.id)
            .then(response => {
    ...
    methods: {
        ...
        onSubmit (evt) {
            ...
            axios.post(`https://omer-chat-api.herokuapp.com/api/chat`, this.chat)
                .then(response => {
